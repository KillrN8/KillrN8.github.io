...
function buydwarvenS(){ //dwarvenS Armor
		var dwarvenSCost = Math.floor(230000 * Math.pow(1.7,dwarvenSCount)); //Starting cost
		...
		var nextdwarvenSCost = Math.floor(230000 * Math.pow(1.7,dwarvenSCount)); //Updates Cost
